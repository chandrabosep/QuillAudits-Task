...
export default function CTA() {
  return (
    <div className="w-full md:w-7/12 m-auto py-10">
      <div className=" max-w-screen-md m-auto md:h-64 flex flex-col md:flex-row  items-center gap-10 my-10 text-[#00000A]">
        <div className="w-10/12 md:w-2/3 flex flex-col gap-6">
